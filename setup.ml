...
(* OASIS_START *)
(* DO NOT EDIT (digest: b5adc28edb3054ba40480fd2c673a6a3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Pure OCaml implementation of the RFB protocol as used in VNC";
          description = None;
          categories = [];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Rfb_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "vnc";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "parse_test.ml"; });
               Executable
                 ({
                     cs_name = "rfb_randomtest";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "rfb_randomtest_main.ml";
                      });
               Executable
                 ({
                     cs_name = "rotate";
                   ...
                   {exec_custom = false; exec_main_is = "rotate.ml"; });
               Executable
                 ({
                     cs_name = "framebuffer";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "vnc";
                           InternalLibrary "vnc_lwt";
                           FindlibPackage ("pcf", None);
                           FindlibPackage ("pcf.unix", None);
                           FindlibPackage ("lwt", None);
                   ...
                   {exec_custom = false; exec_main_is = "framebuffer.ml"; })
            ];
          plugins =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "ra\020\155\174\132\161n\210\014\171S3q\253\129";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
