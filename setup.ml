...
(* OASIS_START *)
(* DO NOT EDIT (digest: 013f6426e824c329a19a2b6b22625500) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [InternalLibrary "vnc"; InternalLibrary "vnc_unix"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "[\173x\193\153\012\014gS\023\203\143<\031y\164";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
